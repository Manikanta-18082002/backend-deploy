...
ansible-pull -i localhost, -U https://github.com/Manikanta-18082002/expense-ansible-roles-tf.git main.yaml -e component=$component -e env=$environment -e appVersion=$app_Version
